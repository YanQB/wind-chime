...
public class CommonListViewHolder {
     ...
     */
    protected CommonListViewHolder(Context context, ViewGroup parent, int layoutId) {
     ...
     */
    public static CommonListViewHolder getViewHolder(Context context, View convertView,
                                                     ViewGroup parent, int layoutId) {

        context = (context == null && parent != null) ? parent.getContext() : context;
        CommonListViewHolder viewHolder = null;
        if (convertView == null) {
            viewHolder = new CommonListViewHolder(context, parent, layoutId);
        } else {
            viewHolder = (CommonListViewHolder) convertView.getTag();
        }
